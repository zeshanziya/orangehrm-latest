...
class EmployeeSalary extends \OrangeHRM\Entity\EmployeeSalary implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\EmployeeSalary' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\EmployeeSalary' . "\0" . 'employee', '' . "\0" . 'OrangeHRM\\Entity\\EmployeeSalary' . "\0" . 'payGrade', '' . "\0" . 'OrangeHRM\\Entity\\EmployeeSalary' . "\0" . 'currencyType', '' . "\0" . 'OrangeHRM\\Entity\\EmployeeSalary' . "\0" . 'amount', '' . "\0" . 'OrangeHRM\\Entity\\EmployeeSalary' . "\0" . 'payPeriod', '' . "\0" . 'OrangeHRM\\Entity\\EmployeeSalary' . "\0" . 'salaryName', '' . "\0" . 'OrangeHRM\\Entity\\EmployeeSalary' . "\0" . 'comment', '' . "\0" . 'OrangeHRM\\Entity\\EmployeeSalary' . "\0" . 'directDebit', 'entityDecorator'];
        }
