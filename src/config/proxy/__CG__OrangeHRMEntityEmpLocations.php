 ...
 */
class EmpLocations extends \OrangeHRM\Entity\EmpLocations implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\EmpLocations' . "\0" . 'employee', '' . "\0" . 'OrangeHRM\\Entity\\EmpLocations' . "\0" . 'location'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EmpLocations $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getLocation(): \OrangeHRM\Entity\Location
    {
     ...
     * {@inheritDoc}
     */
    public function setLocation(\OrangeHRM\Entity\Location $location): void
    {
