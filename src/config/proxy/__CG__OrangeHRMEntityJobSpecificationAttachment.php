 ...
 */
class JobSpecificationAttachment extends \OrangeHRM\Entity\JobSpecificationAttachment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\JobSpecificationAttachment' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\JobSpecificationAttachment' . "\0" . 'fileName', '' . "\0" . 'OrangeHRM\\Entity\\JobSpecificationAttachment' . "\0" . 'fileType', '' . "\0" . 'OrangeHRM\\Entity\\JobSpecificationAttachment' . "\0" . 'fileSize', '' . "\0" . 'OrangeHRM\\Entity\\JobSpecificationAttachment' . "\0" . 'fileContent', '' . "\0" . 'OrangeHRM\\Entity\\JobSpecificationAttachment' . "\0" . 'jobTitle', 'entityDecorator'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (JobSpecificationAttachment $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setJobTitle(\OrangeHRM\Entity\JobTitle $jobTitle)
    {
