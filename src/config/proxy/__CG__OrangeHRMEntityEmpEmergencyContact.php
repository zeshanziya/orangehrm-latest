 ...
 */
class EmpEmergencyContact extends \OrangeHRM\Entity\EmpEmergencyContact implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\EmpEmergencyContact' . "\0" . 'employee', '' . "\0" . 'OrangeHRM\\Entity\\EmpEmergencyContact' . "\0" . 'seqNo', '' . "\0" . 'OrangeHRM\\Entity\\EmpEmergencyContact' . "\0" . 'name', '' . "\0" . 'OrangeHRM\\Entity\\EmpEmergencyContact' . "\0" . 'relationship', '' . "\0" . 'OrangeHRM\\Entity\\EmpEmergencyContact' . "\0" . 'homePhone', '' . "\0" . 'OrangeHRM\\Entity\\EmpEmergencyContact' . "\0" . 'mobilePhone', '' . "\0" . 'OrangeHRM\\Entity\\EmpEmergencyContact' . "\0" . 'officePhone', 'entityDecorator'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EmpEmergencyContact $proxy) {
    ...
    public function setMobilePhone(?string $mobilePhone): void
    {
        ...
        parent::setMobilePhone($mobilePhone);
    }
    ...
    public function setOfficePhone(?string $officePhone): void
    {
        ...
        parent::setOfficePhone($officePhone);
    }
