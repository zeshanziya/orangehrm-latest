 ...
 */
class SelectedDisplayFieldGroup extends \OrangeHRM\Entity\SelectedDisplayFieldGroup implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\SelectedDisplayFieldGroup' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\SelectedDisplayFieldGroup' . "\0" . 'report', '' . "\0" . 'OrangeHRM\\Entity\\SelectedDisplayFieldGroup' . "\0" . 'displayFieldGroup', 'entityDecorator'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SelectedDisplayFieldGroup $proxy) {
