 ...
 */
class EmailProcessor extends \OrangeHRM\Entity\EmailProcessor implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\EmailProcessor' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\EmailProcessor' . "\0" . 'email', '' . "\0" . 'OrangeHRM\\Entity\\EmailProcessor' . "\0" . 'className'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EmailProcessor $proxy) {
