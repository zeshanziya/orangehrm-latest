 ...
 */
class OAuthAuthorizationCode extends \OrangeHRM\Entity\OAuthAuthorizationCode implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\OAuthAuthorizationCode' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\OAuthAuthorizationCode' . "\0" . 'authCode', '' . "\0" . 'OrangeHRM\\Entity\\OAuthAuthorizationCode' . "\0" . 'clientId', '' . "\0" . 'OrangeHRM\\Entity\\OAuthAuthorizationCode' . "\0" . 'userId', '' . "\0" . 'OrangeHRM\\Entity\\OAuthAuthorizationCode' . "\0" . 'redirectUri', '' . "\0" . 'OrangeHRM\\Entity\\OAuthAuthorizationCode' . "\0" . 'expiryDateTime', '' . "\0" . 'OrangeHRM\\Entity\\OAuthAuthorizationCode' . "\0" . 'revoked'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OAuthAuthorizationCode $proxy) {
    ...
    public function setExpiryDateTime(\DateTimeImmutable $expiryDateTime): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setExpiryDateTime', [$expiryDateTime]);

        parent::setExpiryDateTime($expiryDateTime);
    }
