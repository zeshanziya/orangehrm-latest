 ...
 */
class UniqueId extends \OrangeHRM\Entity\UniqueId implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\UniqueId' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\UniqueId' . "\0" . 'lastId', '' . "\0" . 'OrangeHRM\\Entity\\UniqueId' . "\0" . 'tableName', '' . "\0" . 'OrangeHRM\\Entity\\UniqueId' . "\0" . 'fieldName'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (UniqueId $proxy) {
    ...
    public function getLastId(): int
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getLastId', []);
    ...
    public function setLastId(int $lastId): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLastId', [$lastId]);

        parent::setLastId($lastId);
    }
