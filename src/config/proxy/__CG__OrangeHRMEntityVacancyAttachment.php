 ...
 */
class VacancyAttachment extends \OrangeHRM\Entity\VacancyAttachment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\VacancyAttachment' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\VacancyAttachment' . "\0" . 'vacancy', '' . "\0" . 'OrangeHRM\\Entity\\VacancyAttachment' . "\0" . 'fileName', '' . "\0" . 'OrangeHRM\\Entity\\VacancyAttachment' . "\0" . 'fileType', '' . "\0" . 'OrangeHRM\\Entity\\VacancyAttachment' . "\0" . 'fileSize', '' . "\0" . 'OrangeHRM\\Entity\\VacancyAttachment' . "\0" . 'fileContent', '' . "\0" . 'OrangeHRM\\Entity\\VacancyAttachment' . "\0" . 'attachmentType', '' . "\0" . 'OrangeHRM\\Entity\\VacancyAttachment' . "\0" . 'comment', 'entityDecorator'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (VacancyAttachment $proxy) {
