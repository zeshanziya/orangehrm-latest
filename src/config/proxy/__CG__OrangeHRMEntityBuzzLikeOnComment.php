 ...
 */
class BuzzLikeOnComment extends \OrangeHRM\Entity\BuzzLikeOnComment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\BuzzLikeOnComment' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\BuzzLikeOnComment' . "\0" . 'comment', '' . "\0" . 'OrangeHRM\\Entity\\BuzzLikeOnComment' . "\0" . 'employee', '' . "\0" . 'OrangeHRM\\Entity\\BuzzLikeOnComment' . "\0" . 'likedAtUtc', 'entityDecorator'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (BuzzLikeOnComment $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getComment(): \OrangeHRM\Entity\BuzzComment
    {
     ...
     * {@inheritDoc}
     */
    public function setComment(\OrangeHRM\Entity\BuzzComment $comment): void
    {
