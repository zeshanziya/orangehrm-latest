 ...
 */
class OAuthAccessToken extends \OrangeHRM\Entity\OAuthAccessToken implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\OAuthAccessToken' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\OAuthAccessToken' . "\0" . 'accessToken', '' . "\0" . 'OrangeHRM\\Entity\\OAuthAccessToken' . "\0" . 'clientId', '' . "\0" . 'OrangeHRM\\Entity\\OAuthAccessToken' . "\0" . 'userId', '' . "\0" . 'OrangeHRM\\Entity\\OAuthAccessToken' . "\0" . 'expiryDateTime', '' . "\0" . 'OrangeHRM\\Entity\\OAuthAccessToken' . "\0" . 'revoked'];
        }
