 ...
 */
class Module extends \OrangeHRM\Entity\Module implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\Module' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\Module' . "\0" . 'name', '' . "\0" . 'OrangeHRM\\Entity\\Module' . "\0" . 'displayName', '' . "\0" . 'OrangeHRM\\Entity\\Module' . "\0" . 'status'];
        }
