 ...
 */
class Province extends \OrangeHRM\Entity\Province implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\Province' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\Province' . "\0" . 'provinceName', '' . "\0" . 'OrangeHRM\\Entity\\Province' . "\0" . 'provinceCode', '' . "\0" . 'OrangeHRM\\Entity\\Province' . "\0" . 'countryCode'];
        }
