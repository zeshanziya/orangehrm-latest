 ...
 */
class Report extends \OrangeHRM\Entity\Report implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\Report' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\Report' . "\0" . 'name', '' . "\0" . 'OrangeHRM\\Entity\\Report' . "\0" . 'reportGroup', '' . "\0" . 'OrangeHRM\\Entity\\Report' . "\0" . 'useFilterField', '' . "\0" . 'OrangeHRM\\Entity\\Report' . "\0" . 'type'];
        }
    ...
    public function isUseFilterField(): bool
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isUseFilterField', []);

        return parent::isUseFilterField();
    }
    ...
    public function setUseFilterField(bool $useFilterField): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUseFilterField', [$useFilterField]);

        parent::setUseFilterField($useFilterField);
    }
