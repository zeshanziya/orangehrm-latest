...
class OAuthClient extends \OrangeHRM\Entity\OAuthClient implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\OAuthClient' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\OAuthClient' . "\0" . 'name', '' . "\0" . 'OrangeHRM\\Entity\\OAuthClient' . "\0" . 'clientId', '' . "\0" . 'OrangeHRM\\Entity\\OAuthClient' . "\0" . 'clientSecret', '' . "\0" . 'OrangeHRM\\Entity\\OAuthClient' . "\0" . 'redirectUri', '' . "\0" . 'OrangeHRM\\Entity\\OAuthClient' . "\0" . 'confidential', '' . "\0" . 'OrangeHRM\\Entity\\OAuthClient' . "\0" . 'enabled'];
        }
    ...
    public function setConfidential(bool $confidential): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setConfidential', [$confidential]);

        parent::setConfidential($confidential);
    }
