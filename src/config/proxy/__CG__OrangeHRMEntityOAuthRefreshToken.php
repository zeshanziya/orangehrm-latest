 ...
 */
class OAuthRefreshToken extends \OrangeHRM\Entity\OAuthRefreshToken implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\OAuthRefreshToken' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\OAuthRefreshToken' . "\0" . 'refreshToken', '' . "\0" . 'OrangeHRM\\Entity\\OAuthRefreshToken' . "\0" . 'accessToken', '' . "\0" . 'OrangeHRM\\Entity\\OAuthRefreshToken' . "\0" . 'expiryDateTime', '' . "\0" . 'OrangeHRM\\Entity\\OAuthRefreshToken' . "\0" . 'revoked'];
        }
