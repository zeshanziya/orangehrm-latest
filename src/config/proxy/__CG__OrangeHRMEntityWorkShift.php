 ...
 */
class WorkShift extends \OrangeHRM\Entity\WorkShift implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\WorkShift' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\WorkShift' . "\0" . 'name', '' . "\0" . 'OrangeHRM\\Entity\\WorkShift' . "\0" . 'hoursPerDay', '' . "\0" . 'OrangeHRM\\Entity\\WorkShift' . "\0" . 'startTime', '' . "\0" . 'OrangeHRM\\Entity\\WorkShift' . "\0" . 'endTime', 'entityDecorator'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (WorkShift $proxy) {
    ...
    public function getHoursPerDay(): float
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHoursPerDay', []);

        return parent::getHoursPerDay();
    }
    ...
    public function setHoursPerDay(float $hoursPerDay): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setHoursPerDay', [$hoursPerDay]);

        parent::setHoursPerDay($hoursPerDay);
    }
