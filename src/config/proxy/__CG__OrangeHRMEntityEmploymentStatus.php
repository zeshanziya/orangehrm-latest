 ...
 */
class EmploymentStatus extends \OrangeHRM\Entity\EmploymentStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\EmploymentStatus' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\EmploymentStatus' . "\0" . 'name', '' . "\0" . 'OrangeHRM\\Entity\\EmploymentStatus' . "\0" . 'employees'];
        }
