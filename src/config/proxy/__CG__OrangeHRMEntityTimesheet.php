 ...
 */
class Timesheet extends \OrangeHRM\Entity\Timesheet implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\Timesheet' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\Timesheet' . "\0" . 'state', '' . "\0" . 'OrangeHRM\\Entity\\Timesheet' . "\0" . 'startDate', '' . "\0" . 'OrangeHRM\\Entity\\Timesheet' . "\0" . 'endDate', '' . "\0" . 'OrangeHRM\\Entity\\Timesheet' . "\0" . 'employee', 'entityDecorator'];
        }
