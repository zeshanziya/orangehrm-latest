 ...
 */
class DisplayField extends \OrangeHRM\Entity\DisplayField implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\DisplayField' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\DisplayField' . "\0" . 'className', '' . "\0" . 'OrangeHRM\\Entity\\DisplayField' . "\0" . 'selectedDisplayFields', 'reportGroup', 'name', 'label', 'fieldAlias', 'sortable', 'sortOrder', 'sortField', 'elementType', 'elementProperty', 'width', 'exportable', 'textAlignmentStyle', 'isValueList', 'displayFieldGroup', 'defaultValue', 'encrypted', 'meta'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DisplayField $proxy) {
