 ...
 */
class PerformanceTracker extends \OrangeHRM\Entity\PerformanceTracker implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\PerformanceTracker' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\PerformanceTracker' . "\0" . 'trackerName', '' . "\0" . 'OrangeHRM\\Entity\\PerformanceTracker' . "\0" . 'addedDate', '' . "\0" . 'OrangeHRM\\Entity\\PerformanceTracker' . "\0" . 'modifiedDate', '' . "\0" . 'OrangeHRM\\Entity\\PerformanceTracker' . "\0" . 'status', '' . "\0" . 'OrangeHRM\\Entity\\PerformanceTracker' . "\0" . 'employee', '' . "\0" . 'OrangeHRM\\Entity\\PerformanceTracker' . "\0" . 'addedBy', '' . "\0" . 'OrangeHRM\\Entity\\PerformanceTracker' . "\0" . 'performanceTrackerReviewer', 'entityDecorator'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (PerformanceTracker $proxy) {
    ...
    public function getTrackerName(): string
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTrackerName', []);

        return parent::getTrackerName();
    }
    ...
    public function setTrackerName(string $trackerName): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTrackerName', [$trackerName]);

        parent::setTrackerName($trackerName);
    }
    ...
    public function getPerformanceTrackerReviewer()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPerformanceTrackerReviewer', []);

        return parent::getPerformanceTrackerReviewer();
    }
    ...
    public function setPerformanceTrackerReviewer($performanceTrackerReviewer): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPerformanceTrackerReviewer', [$performanceTrackerReviewer]);

        parent::setPerformanceTrackerReviewer($performanceTrackerReviewer);
    }

    /**
     * {@inheritDoc}
     */
    public function getAddedBy(): \OrangeHRM\Entity\Employee
    {
     ...
     * {@inheritDoc}
     */
    public function setAddedBy(\OrangeHRM\Entity\Employee $addedBy): void
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAddedBy', [$addedBy]);

        parent::setAddedBy($addedBy);
    }
