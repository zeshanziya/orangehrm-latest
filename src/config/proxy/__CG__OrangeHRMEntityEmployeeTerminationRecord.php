 ...
 */
class EmployeeTerminationRecord extends \OrangeHRM\Entity\EmployeeTerminationRecord implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\EmployeeTerminationRecord' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\EmployeeTerminationRecord' . "\0" . 'date', '' . "\0" . 'OrangeHRM\\Entity\\EmployeeTerminationRecord' . "\0" . 'note', '' . "\0" . 'OrangeHRM\\Entity\\EmployeeTerminationRecord' . "\0" . 'terminationReason', '' . "\0" . 'OrangeHRM\\Entity\\EmployeeTerminationRecord' . "\0" . 'employee', 'entityDecorator'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EmployeeTerminationRecord $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getTerminationReason(): ?\OrangeHRM\Entity\TerminationReason
    {
     ...
     * {@inheritDoc}
     */
    public function setTerminationReason(?\OrangeHRM\Entity\TerminationReason $terminationReason): void
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTerminationReason', [$terminationReason]);

        parent::setTerminationReason($terminationReason);
    }
