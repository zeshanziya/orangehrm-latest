 ...
 */
class EmpDirectDebit extends \OrangeHRM\Entity\EmpDirectDebit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\EmpDirectDebit' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\EmpDirectDebit' . "\0" . 'salary', '' . "\0" . 'OrangeHRM\\Entity\\EmpDirectDebit' . "\0" . 'routingNumber', '' . "\0" . 'OrangeHRM\\Entity\\EmpDirectDebit' . "\0" . 'account', '' . "\0" . 'OrangeHRM\\Entity\\EmpDirectDebit' . "\0" . 'amount', '' . "\0" . 'OrangeHRM\\Entity\\EmpDirectDebit' . "\0" . 'accountType', '' . "\0" . 'OrangeHRM\\Entity\\EmpDirectDebit' . "\0" . 'transactionType'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EmpDirectDebit $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getSalary(): \OrangeHRM\Entity\EmployeeSalary
    {
     ...
     * {@inheritDoc}
     */
    public function setSalary(\OrangeHRM\Entity\EmployeeSalary $salary): void
    {
    ...
    public function getRoutingNumber(): int
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getRoutingNumber', []);

        return parent::getRoutingNumber();
    }
    ...
    public function setRoutingNumber(int $routingNumber): void
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setRoutingNumber', [$routingNumber]);

        parent::setRoutingNumber($routingNumber);
    }
