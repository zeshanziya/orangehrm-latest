 ...
 */
class CandidateAttachment extends \OrangeHRM\Entity\CandidateAttachment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\CandidateAttachment' . "\0" . 'id', '' . "\0" . 'OrangeHRM\\Entity\\CandidateAttachment' . "\0" . 'candidate', '' . "\0" . 'OrangeHRM\\Entity\\CandidateAttachment' . "\0" . 'fileName', '' . "\0" . 'OrangeHRM\\Entity\\CandidateAttachment' . "\0" . 'fileType', '' . "\0" . 'OrangeHRM\\Entity\\CandidateAttachment' . "\0" . 'fileSize', '' . "\0" . 'OrangeHRM\\Entity\\CandidateAttachment' . "\0" . 'fileContent', '' . "\0" . 'OrangeHRM\\Entity\\CandidateAttachment' . "\0" . 'attachmentType', 'entityDecorator'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CandidateAttachment $proxy) {
