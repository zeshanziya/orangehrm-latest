 ...
 */
class Config extends \OrangeHRM\Entity\Config implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'OrangeHRM\\Entity\\Config' . "\0" . 'name', '' . "\0" . 'OrangeHRM\\Entity\\Config' . "\0" . 'value'];
        }
